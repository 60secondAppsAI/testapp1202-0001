  ...
  data() {
    return {
      ...
      columns: [
		...
		dataIndex: 'valuationRange',
          visible: true,
          scopedSlots: { customRender: 'valuationRange' },
          sorter: true
          //sorter: (a, b) => a.valuationRange - b.valuationRange,
          //sorter: (a, b) => a.valuationRange.localeCompare(b.valuationRange),
        },
      ],
      pagination: {
        current: 1,
