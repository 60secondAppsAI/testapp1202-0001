...
<template>
  ...
  <base-input label="OfferExpiryDate" type="text" placeholder="Enter OfferExpiryDate" v-model="offerToAdd.offerExpiryDate"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'offerExpiryDate',
          visible: true,
          scopedSlots: { customRender: 'offerExpiryDate' },
          sorter: true
          //sorter: (a, b) => a.offerExpiryDate - b.offerExpiryDate,
          //sorter: (a, b) => a.offerExpiryDate.localeCompare(b.offerExpiryDate),
        },
      ],
      pagination: {
        current: 1,
