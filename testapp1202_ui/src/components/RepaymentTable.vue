  ...
  data() {
    return {
      ...
      columns: [
		...
		dataIndex: 'repaymentDueDate',
          visible: true,
          scopedSlots: { customRender: 'repaymentDueDate' },
          sorter: true
          //sorter: (a, b) => a.repaymentDueDate - b.repaymentDueDate,
          //sorter: (a, b) => a.repaymentDueDate.localeCompare(b.repaymentDueDate),
        },
        {
		...
		dataIndex: 'repaymentAmount',
          ...
          sorter: true
          //sorter: (a, b) => a.repaymentAmount - b.repaymentAmount,
          //sorter: (a, b) => a.repaymentAmount.localeCompare(b.repaymentAmount),
        },
      ],
      pagination: {
        current: 1,
