						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="PaymentType" type="text" placeholder="Enter PaymentType" v-model="paymentToAdd.paymentType"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Payment Date</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Payment Type</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="PaymentType" type="text" placeholder="Enter PaymentType" v-model="paymentDetails.paymentType"></input>
																		</div>
						</td>
														</tr>
